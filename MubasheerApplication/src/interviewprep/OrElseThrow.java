...
public class OrElseThrow {
	public static void main(String[] args) {
        ...
        String employeeName = getEmployeeNameById(empMap, 7);
...
//        System.out.println("Default name: " + defaultName);
	...
	private static String getEmployeeNameById(Map<Integer, Employee3> empMap, int id) {
		 ...
		 return Optional.ofNullable(empMap.get(id))
	                ...
	                .orElseThrow(()->new IllegalArgumentException("The Id you passed is not having any name associated with it, please pass another Id"));
